...
const menuOptions = [
  {
    icon : "wallet-outline",
    text : "Mi billetera",
    route: "/informacion-bancaria-maestro"
  },
  {
    icon : "document-attach-outline",
    text : "Documentos",
    route: "/documentos-maestro"
  },
    ...
    <SafeAreaView style={ styles.container }>
      ...
      <ScrollView contentContainerStyle={ styles.scrollContent }>
        ...
        <View style={ styles.profileHeader }>
          ...
          <View>
            <Text
              style={ styles.name }>{ maestroInfo.nombre } { maestroInfo.apellido }</Text>
        ...
        <View style={ styles.statsCard }>
          <Text style={ styles.statsMainText }>
            <Text
              style={ { fontWeight: "bold" } }>{ maestroInfo.trabajosCompletados }</Text> Trabajos
            completados
          </Text>
          <Text style={ styles.statsSubText }>Miembro
            desde { maestroInfo.miembroDesde }</Text>
          <Text style={ styles.qualityText }>Calidad alta ⭐</Text>
          <Pressable onPress={ () => console.log( "Ver reseñas" ) }>
      ...
      >
        ...
        >
          ...
          >
            <Ionicons name="log-out-outline" size={ 70 } color="#3498DB"
                      style={ { marginBottom: 15 } }/>

            <Text style={ styles.modalTitle }>¿Seguro que deseas cerrar
              sesión?</Text>
