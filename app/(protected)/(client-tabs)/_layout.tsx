...
const TabIcon = ( { iconName, name, focused }: {
  iconName: any;
  name: string;
  focused: boolean
} ) => {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={ {
          title     : "Buscar",
          tabBarIcon: ( { focused } ) => <TabIcon iconName="add-circle"
                                                  name="Buscar"
                                                  focused={ focused }/>
        } }
      />
      <Tabs.Screen
        ...
        options={ {
          ...
          tabBarIcon: ( { focused } ) => <TabIcon
            iconName="checkmark-circle-outline" name="Solicitudes"
            focused={ focused }/>
        } }
      />
      <Tabs.Screen
        ...
        options={ {
          title     : "Pagos",
          tabBarIcon: ( { focused } ) => <TabIcon iconName="wallet-outline"
                                                  name="Pagos"
                                                  focused={ focused }/>
        } }
      />
