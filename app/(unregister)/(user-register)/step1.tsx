...
export default function UserRegisterStep1() {
	...
	const onSubmit                   = async ( data: any ) => {
		...
		router.push( "/(unregister)/(user-register)/step2" )
	}
					...
					<Controller
						...
						render={ ( { field: { onChange, onBlur, value } } ) => (
							<>
								...
								<TextInput
									editable={ !submiting }
									style={ styles.input } placeholder="" // Placeholder vacío
									onBlur={ onBlur }
					...
					<Controller
						...
						render={ ( { field: { onChange, onBlur, value } } ) => (
							<View style={ {
								...
								{/* 👇 INICIO ESTRUCTURA REPETIR CONTRASEÑA (Sincronizada) */}
								<View style={ styles.passwordContainer }>
									<TextInput
										style={ [styles.input, styles.passwordInput] }
										editable={ !submiting }
								...
								{/* 👆 FIN ESTRUCTURA REPETIR CONTRASEÑA */}
							</View>
...
const styles = StyleSheet.create( {
	...
	passwordContainer: { // NUEVO ESTILO DE CONTENEDOR DE CONTRASEÑA
		flexDirection: "row",
		alignItems: "center",
		width: "100%",
		borderBottomWidth: 1,
	...
	passwordInput: { // Estilo de input dentro del passwordContainer
		flex: 1,
		marginBottom: 0,
		paddingHorizontal: 0,
		paddingRight: 10, // Asegura que el texto no toque el ojo
	},
	eyeButton: { // NUEVO ESTILO DE BOTÓN DE OJO
